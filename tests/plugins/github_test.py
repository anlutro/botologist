...
class GithubPluginTest(PluginTestCase):
    ...
    def test_push(self):
        ...
        self.assertEqual(
            "[baxterthehacker/public-repo] New commit to changes by baxterthehacker: Update README.md - https://github.com/baxterthehacker/public-repo/commit/0d1a26e67d",
            ret[0],
        )
    ...
    def test_issue(self):
        ...
        self.assertEqual(
            "[baxterthehacker/public-repo] Issue opened by baxterthehacker: Spelling error in the README file - https://github.com/baxterthehacker/public-repo/issues/2",
            ret,
        )
    ...
    def test_pull_request(self):
        ...
        self.assertEqual(
            "[baxterthehacker/public-repo] Pull request opened by baxterthehacker: Update the README with new information - https://github.com/baxterthehacker/public-repo/pull/1",
            ret,
        )
